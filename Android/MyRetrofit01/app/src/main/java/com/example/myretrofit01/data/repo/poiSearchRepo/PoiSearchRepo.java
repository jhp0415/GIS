...
public class PoiSearchRepo {
     ...
     */
    public PoiSearchRepo(String transactionId, String distanceUnit, Integer numberOfPois, Integer numberOfAddress, String providerId, List<Poi> pois, List<Object> residentialAddress) {
        super();
