...
public class CurrentPlaceActivity extends AppCompatActivity
    ...
    /**
     * 새로 업데이트된 구글맵에서는 나의 위치를 알기 위해서 FusedLocationProviderClient 만 얻어와서,
     * getLastLocation 메소드를 사용하고,
     * completion listener만 달면 위치를 얻어올 수 있다.
     */
    ...
    LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationList.size() > 0) {
                location = locationList.get(locationList.size() - 1);   //가장 마지막 위치
